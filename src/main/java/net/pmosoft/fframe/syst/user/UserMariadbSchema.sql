...
,USR_EMAIL   VARCHAR(40)        NULL comment '사용자이메일'    
,USR_PW      VARCHAR(20)        NULL comment '사용자암호'      
...
CREATE TABLE TSYUR00030 (
 USR_ID      VARCHAR(20)    NOT NULL COMMENT '사용자아이디'    
,USR_PRJ_ID  VARCHAR(20)    NOT NULL comment '사용자프로젝트아이디'    
,USR_PRJ_NM  VARCHAR(100)       NULL comment '사용자프로젝트명'    
,USE_YN       CHAR(1)           NULL comment '사용여부'        
,REG_DT       DATE              NULL comment '등록일시'        
,REG_USR_ID  VARCHAR(20)        NULL comment '등록사용자아이디'
,UPD_DT       DATE              NULL comment '변경일시'        
