    ...
    [
     ...
     //-------------------------------------------
     {
       ...
       ,items : 
        ...
        ,'->'
        ,{xtype:'button' , text:'조회' ,id : 'selBtn', handler:'selBtn' , iconCls:'x-fa fa-filter'}
     ...
     ,{
        ...
        ,columns :
         [
          ...
          ,{text:'코드유형코드' , dataIndex:'CD_TY_CD'    , style:'text-align:center' , align:'left'  , editor:{xtype:'textfield'}}
