         ...
         //-------------------------------------------
         {
             ...
             ,items :
              [
                  ...
                  ,{xtype:'button' ,text:'저장' , handler:'savBtn'}
...
//             }
            ,columns :
             [
              {xtype:'rownumberer'}
              ,{text:'DB명'           , dataIndex:'DB_NM'          , style:'text-align:center' , flex:1, editor:{xtype:'textfield'} }
              ,{text:'소유자'         , dataIndex:'OWNER'          , style:'text-align:center' , flex:1, editor:{xtype:'textfield'} }
              ,{text:'테이블명'       , dataIndex:'TAB_NM'         , style:'text-align:center' , flex:1, editor:{xtype:'textfield'} }
              ,{text:'컬럼아이디'     , dataIndex:'COL_ID'         , style:'text-align:center' , flex:1, editor:{xtype:'textfield'} }
              ,{text:'컬럼명'         , dataIndex:'COL_NM'         , style:'text-align:center' , flex:1, editor:{xtype:'textfield'} }
              ,{text:'컬럼한글명'     , dataIndex:'COL_HNM'        , style:'text-align:center' , flex:1, editor:{xtype:'textfield'} }
              ,{text:'컬럼설명'       , dataIndex:'COL_DESC'       , style:'text-align:center' , flex:1, editor:{xtype:'textfield'} }
              ,{text:'데이터타입명'   , dataIndex:'DATA_TYPE_NM'   , style:'text-align:center' , flex:1, editor:{xtype:'textfield'} }
              ,{text:'길이'           , dataIndex:'LEN'            , style:'text-align:center' , flex:1, editor:{xtype:'textfield'} }
              ,{text:'소수점수'       , dataIndex:'DECIMAL_CNT'    , style:'text-align:center' , flex:1, editor:{xtype:'textfield'} }
              ,{text:'데이터타입설명' , dataIndex:'DATA_TYPE_DESC' , style:'text-align:center' , flex:1, editor:{xtype:'textfield'} }
